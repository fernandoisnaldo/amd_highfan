...
Script that increases GPU fan speed, when it detects temperature close to critical, was created especially for a default model of AMD Radeon RX 56 Vega, running on a Debian operating system with amdgpu driver.
